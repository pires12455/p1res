	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\nBem vindo ao grupo *${mdata.subject}*\n\n leia a desc e n seja Ghost, Espero que goste do grupo ❤️`
				...
				teks = `Tchau @${num.split('@')[0]} mais uma vaga no grupo😳👋`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] CPires Este é um recurso especial para o Pires ❌',
					ownerB: '[❗] CPires Este é um recurso especial para o Pires ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de CAUSS. Registre-se para fazer amizade com o bot Causs por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Pires|17\n\n──「 Pires BOT 」──`,
			...
			const ownerNumber = ["556996103915@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"556996103915@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["556996103915@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556996103915@s.whatsapp.net"]//ubah nomor lo
			const premium = ["556996103915@s.whatsapp.net","558296156440@s.whatsapp.net"] 
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT Pires ✨* 」\n*│+ wa.me/556996103915*╰──────*「 *CAUSS* 」*────*\n\n*_SE QUER SER ADMIN DO BOT Pires*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
